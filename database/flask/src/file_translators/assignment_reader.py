...
def parse_arguments():
    parser = argparse.ArgumentParser(description='Process a JSON file containing questions data.')
    parser.add_argument('file_path', type=str, help='Path to the JSON file to be processed')
