...
def get_submissions_():
    ...
    for param, value in query_params.items():
        ...
        if param in ['submission_id', 'original_file_name', 'student_id', 'assignment_id', 'submitter_type', 
                     'total_score', 'max_score', 'percentage_score', 'submission_time', 
                     'start_time', 'end_time', 'flag', 'submission_mechanism']:
    ...
    with admin_login(password) as conn:  # Assuming admin_login() uses context management for the connection
